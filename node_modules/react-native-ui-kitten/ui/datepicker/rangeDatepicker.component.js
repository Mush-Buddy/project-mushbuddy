 ...
 */
class RangeDatepickerComponent extends baseDatepicker_component_1.BaseDatepickerComponent {
    constructor(props) {
        super(props);
        this.clear = () => {
...
exports.RangeDatepicker = theme_1.styled(RangeDatepickerComponent);

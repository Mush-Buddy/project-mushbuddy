...
class BaseCalendarComponent extends react_1.default.Component {
    constructor() {
        ...
        this.renderWeekdayElement = (weekday, index) => {
            return (react_1.default.createElement(calendarDateContent_component_1.CalendarDateContent, { key: index, textStyle: this.getWeekdayStyle(this.props.themedStyle) }, weekday));
        };
        this.renderDayElement = ({ date }, style) => {
            return (react_1.default.createElement(calendarDateContent_component_1.CalendarDateContent, { style: style.container, textStyle: style.text }, this.dateService.format(date, FORMAT_DAY)));
        };
        this.renderMonthElement = ({ date }, style) => {
            return (react_1.default.createElement(calendarDateContent_component_1.CalendarDateContent, { style: style.container, textStyle: style.text }, this.dateService.format(date, FORMAT_MONTH)));
        };
        this.renderYearElement = ({ date }, style) => {
            return (react_1.default.createElement(calendarDateContent_component_1.CalendarDateContent, { style: style.container, textStyle: style.text }, this.dateService.format(date, FORMAT_YEAR)));
        };
        this.renderDayPickerElement = (date, style) => {
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(calendarMonthHeader_component_1.CalendarMonthHeader, { style: style.daysHeaderContainer, data: this.dateService.getDayOfWeekNames() }, this.renderWeekdayElement),
                react_1.default.createElement(divider_component_1.Divider, { style: style.divider }),
                react_1.default.createElement(calendarPicker_component_1.CalendarPicker, { rowStyle: style.row, data: this.createDates(date), onSelect: this.onDaySelect, isItemSelected: this.isDaySelected, isItemDisabled: this.isDayDisabled, isItemToday: this.isDayToday, shouldItemUpdate: this.shouldUpdateDate }, this.renderDayIfNeeded)));
        };
        this.renderMonthPickerElement = (date, style) => {
            return (react_1.default.createElement(calendarPicker_component_1.CalendarPicker, { rowStyle: style.row, data: this.dataService.createMonthPickerData(date, PICKER_ROWS, PICKER_COLUMNS), onSelect: this.onMonthSelect, isItemSelected: this.isMonthSelected, isItemDisabled: this.isMonthDisabled, isItemToday: this.isMonthToday }, this.props.renderMonth || this.renderMonthElement));
        };
    ...
    render() {
        ...
        return (react_1.default.createElement(react_native_1.View, Object.assign({}, restProps, { style: [container, style] }),

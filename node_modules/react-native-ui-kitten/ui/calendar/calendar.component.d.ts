 ...
 */
export declare class CalendarComponent<D = Date> extends BaseCalendarComponent<CalendarProps<D>, D> {
...
export declare const Calendar: import("../../theme").StyledComponentClass<CalendarProps<Date>>;

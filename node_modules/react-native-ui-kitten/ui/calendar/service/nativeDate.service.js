...
class NativeDateService extends date_service_1.DateService {
    ...
    format(date, format) {
        return fecha_1.default.format(date, format || this.options.format);
    }
    /**
    ...
    getFechaDayNames(style) {
        switch (style) {
            case type_1.TranslationWidth.SHORT:
                return fecha_1.default.i18n.dayNamesShort;
            case type_1.TranslationWidth.LONG:
                return fecha_1.default.i18n.dayNames;
        }
    }
    getFechaMonthNames(style) {
        switch (style) {
            case type_1.TranslationWidth.SHORT:
                return fecha_1.default.i18n.monthNamesShort;
            case type_1.TranslationWidth.LONG:
                return fecha_1.default.i18n.monthNames;
        }
    }
    setFechaLocaleData(config) {
        fecha_1.default.i18n.dayNames = config.dayNames[type_1.TranslationWidth.LONG];
        fecha_1.default.i18n.dayNamesShort = config.dayNames[type_1.TranslationWidth.SHORT];
        fecha_1.default.i18n.monthNames = config.monthNames[type_1.TranslationWidth.LONG];
        fecha_1.default.i18n.monthNamesShort = config.monthNames[type_1.TranslationWidth.SHORT];
    }
}

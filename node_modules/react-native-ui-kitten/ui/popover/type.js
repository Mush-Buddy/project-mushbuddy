...
Offsets.MARGIN = new class {
    ...
    apply(frame, value) {
        return new type_1.Frame(value, value, value, value);
    }
};
Offsets.MARGIN_HORIZONTAL = new class {
    ...
    apply(frame, value) {
        return new type_1.Frame(value, frame.origin.y, value, frame.size.height);
    }
};
Offsets.MARGIN_VERTICAL = new class {
    ...
    apply(frame, value) {
        return new type_1.Frame(frame.origin.x, value, frame.size.width, value);
    }
};
Offsets.MARGIN_LEFT = new class {
    ...
    apply(frame, value) {
        return new type_1.Frame(value, frame.origin.y, frame.size.width, frame.size.height);
    }
};
Offsets.MARGIN_TOP = new class {
    ...
    apply(frame, value) {
        return new type_1.Frame(frame.origin.x, value, frame.size.width, frame.size.height);
    }
};
Offsets.MARGIN_RIGHT = new class {
    ...
    apply(frame, value) {
        return new type_1.Frame(frame.origin.x, frame.origin.y, value, frame.size.height);
    }
};
Offsets.MARGIN_BOTTOM = new class {
    ...
    apply(frame, value) {
        return new type_1.Frame(frame.origin.x, frame.origin.y, frame.size.width, value);
    }
};
class PlacementOptions {
    constructor(source = type_1.Frame.zero(), other = type_1.Frame.zero(), bounds = type_1.Frame.zero(), offsets = type_1.Frame.zero()) {
        this.source = source;
        this.other = other;
        this.bounds = bounds;
...
PopoverPlacements.LEFT = new class {
    ...
    frame(options) {
        ...
        const x = services_1.I18nLayoutService.select(origin.x + options.offsets.origin.x, options.bounds.size.width - size.width - (origin.x + options.offsets.size.width));
        return new type_1.Frame(x, origin.y, size.width, size.height);
    }
    flex() {
        return {
            direction: 'row',
...
PopoverPlacements.LEFT_START = new class {
    ...
    frame(options) {
        ...
        return new type_1.Frame(origin.x, origin.y - (options.other.size.height - size.height) / 2 + options.offsets.origin.y, size.width, size.height);
    }
    flex() {
        return {
            direction: 'row',
...
PopoverPlacements.LEFT_END = new class {
    ...
    frame(options) {
        const { origin, size } = this.parent().frame(options);
        return new type_1.Frame(origin.x, origin.y + (options.other.size.height - size.height) / 2 - options.offsets.size.height, size.width, size.height);
    }
    flex() {
        return {
            direction: 'row',
...
PopoverPlacements.TOP = new class {
    ...
    frame(options) {
        ...
        const x = services_1.I18nLayoutService.select(origin.x, options.bounds.size.width - (origin.x + size.width));
        return new type_1.Frame(x, origin.y + options.offsets.origin.y, size.width, size.height);
    }
    flex() {
        return {
            direction: 'column',
...
PopoverPlacements.TOP_START = new class {
    ...
    frame(options) {
        const { origin, size } = this.parent().frame(options);
        return new type_1.Frame(origin.x - (options.other.size.width - size.width) / 2 + options.offsets.origin.x, origin.y, size.width, size.height);
    }
    flex() {
        return {
            direction: 'column',
...
PopoverPlacements.TOP_END = new class {
    ...
    frame(options) {
        const { origin, size } = this.parent().frame(options);
        return new type_1.Frame(origin.x + (options.other.size.width - size.width) / 2 - options.offsets.size.width, origin.y, size.width, size.height);
    }
    flex() {
        return {
            direction: 'column',
...
PopoverPlacements.RIGHT = new class {
    ...
    frame(options) {
        ...
        const x = services_1.I18nLayoutService.select(origin.x - options.offsets.size.width, options.bounds.size.width - size.width - (origin.x - options.offsets.size.width));
        return new type_1.Frame(x, origin.y, size.width, size.height);
    }
    flex() {
        return {
...
PopoverPlacements.BOTTOM = new class {
    ...
    frame(options) {
        ...
        const x = services_1.I18nLayoutService.select(origin.x, options.bounds.size.width - (origin.x + size.width));
        return new type_1.Frame(x, origin.y - options.offsets.size.height, size.width, size.height);
    }
    flex() {
        return {
...
const fitsStart = (frame, other) => {
    return services_1.I18nLayoutService.select(fitsLeft, fitsRight)(frame, other);
};
const fitsEnd = (frame, other) => {
    return services_1.I18nLayoutService.select(fitsRight, fitsLeft)(frame, other);
};
